...
function MovieDetailsPage() {
    ...
    return (
        <>
            <br />
            <button className='btnInfo' onClick={clickHandler}>go back</button>
            ...
            <ul className='buttonInfo'>
                <li><NavLink className='addInfo' activeClassName='activeAddInfo' to={{...location, pathname: `${url}/cast`}}>Cast</NavLink></li>
